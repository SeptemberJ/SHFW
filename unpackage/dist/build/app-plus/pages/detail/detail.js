      ...
      !(function(){
        var uniAppViewReadyCallback = function(){
          setCssToHead([".",[1],"ItemBar.",[1],"data-v-564d0a8a{ height: 40; line-height: 40px; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; border-bottom: 1px solid #efefef; padding: 0 15px; background: #FFFFFF; }\n.",[1],"BottomBts.",[1],"data-v-564d0a8a{ width: 100%; height: 45px; background: #e64340; position: fixed; left: 0; bottom: 0; line-height: 45px; text-align: center; color: #FFFFFF; font-size: 16px; font-weight: bold; }\n",],undefined,{path:"./pages/detail/detail.wxss"})();
